...
fun ResponsiveComposedChart(
    ...
    ResponsiveContainer(modifier = modifier.height(300.dp)) { _, _ ->
        ComposedChart(
            data = getResponsiveComposedChartData(),
 ...
 */
private fun getResponsiveComposedChartData() = ComposedChartData(
    title = "Responsive Composed Chart",
    categories = listOf("Page A", "Page B", "Page C", "Page D", "Page E", "Page F"),
    lineDataSets = listOf(
        LineDataSet(
            label = "uv",
            dataPoints = listOf(
    ...
    config = ChartConfig(
        ...
        cartesianGrid = CartesianGridConfig(
            horizontalLineColor = Color(0xFFF5F5F5),
            verticalLineColor = Color(0xFFF5F5F5),
